...
miscsec:NewKeybind("KeybindText", "KeybindInfo", Enum.KeyCode.F, function()
    Library:ToggleUI()
end)

local creditSection = creditsTab:NewSection("Scripter - Shade")
local xheptccredit = creditsTab:NewSection("UI Library - xHeptc")
